...
import { getRingStatus } from "../../api/ring";
...
export function SettingsView() {
  ...
  const [ringStatus, setRingStatus] = useState<{ connected: boolean; email?: string } | null>(null);
      ...
      <Card className={styles.card}>
        ...
        <div className={styles.status}>
          ...
          <Badge appearance="filled" color={ringStatus?.connected ? "success" : "warning"}>
            {ringStatus?.connected ? `Connected (${ringStatus.email})` : "Not connected"}
          </Badge>
        </div>
      </Card>
